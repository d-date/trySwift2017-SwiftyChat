...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let feedVC = UIStoryboard(name: "Feed", bundle: nil).instantiateInitialViewController()!
        let linkAccountVC = UIStoryboard(name: "LinkAccount", bundle: nil).instantiateInitialViewController()!
        
        feedVC.tabBarItem.image = UIImage(named: "Message")
        linkAccountVC.tabBarItem.image = UIImage(named: "Account")
        
        let vcs = [feedVC, linkAccountVC]
